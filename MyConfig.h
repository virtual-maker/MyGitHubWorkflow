...
/**
 * @defgroup CANSettingGrpPub CAN
 * @ingroup TransportSettingGrpPub
 * @brief These options are specific to the CAN bus family of wired transport modules.
 *
...
/**
 * @def MY_CAN_INT
 * @brief Define interrupt pin to CAN module for use of the interrupt feature.
 * Otherwise the interrupt pin of the CAN module can be left unconnected.
 */
 ...
 */
#ifndef MY_CAN_CS
#define MY_CAN_CS (DEFAULT_CAN_CS_PIN)
#endif
...
/**
 * @def MY_CAN_SLOTS_COUNT
 * @brief Message assemble slots count.
 *
 * Since long messages must be sliced in up to 4 CAN packets
 * and arrive mixed with other messages, an array of assemble slots is required.
 * The default size is 8 assemble slots.
*/
#ifndef MY_CAN_SLOTS_COUNT
#define MY_CAN_SLOTS_COUNT (8u)
#endif

/**
 * @def MY_CAN_RX_BUFFER_SIZE
 * @brief Additional buffer for CAN packets.
 *
 * The MCP2515 has only 2 internal receive buffer for CAN telegrams.
 * When the traffic in the network to this node is hight,
 * there is good chance for lost CAN packets.
 * This buffer extends the number of received CAN telegrams.
 * The buffer is only active if MY_CAN_INT is defined.
 */
#if defined(MY_CAN_INT)
#ifndef MY_CAN_RX_BUFFER_SIZE
#define MY_CAN_RX_BUFFER_SIZE (16u)
#endif
#endif

/** @}*/ // End of CANSettingGrpPub group
...
#define MY_CAN_SPEED
#define MY_CAN_CLOCK
#define MY_CAN_SLOTS_COUNT
#define MY_CAN_RX_BUFFER_SIZE
